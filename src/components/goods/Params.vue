  ...
  <div>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="paramsInfo">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async removeParams(attrId) {
      const ruseltConfirm = await this.$confirm(
        '此操作将永久删除该参数, 是否继续?',
        '提示',
        {
    ...
    async saveAttrVals(row) {
      ...
      // console.log(res)
      if (res.meta.status !== 200) {
        return this.$message.error('修改' + this.titleText + '选项失败')
      }
      this.getParamsData()
      this.$message.success('修改' + this.titleText + '选项成功')
    }
  }
}
</script>
